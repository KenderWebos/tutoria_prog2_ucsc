# https://www.beecrowd.com.br/judge/es/problems/view/1021
...
def main():
    ...
    n = n % 1
    print("{} moeda(s) de R$ 0.50".format(int(n/0.5)))
    n = n % 0.5
    print("{} moeda(s) de R$ 0.25".format(int(n/0.25)))
    n = n % 0.25
    print("{} moeda(s) de R$ 0.10".format(int(n/0.1)))
    n = n % 0.1
